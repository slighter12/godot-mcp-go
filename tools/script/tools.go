...
func (t *ListProjectScriptsTool) Description() string {
	return "[file-based] Lists all scripts in the project"
}
func (t *ListProjectScriptsTool) Annotations() *mcp.ToolAnnotations {
...
func (t *ReadScriptTool) Description() string { return "[file-based] Reads a specific script" }
func (t *ReadScriptTool) Annotations() *mcp.ToolAnnotations {
	return &mcp.ToolAnnotations{
		ReadOnlyHint:   types.BoolPtr(true),
		IdempotentHint: types.BoolPtr(true),
	}
...
func (t *ModifyScriptTool) Description() string { return "[editor-plugin] Modifies a script" }
func (t *ModifyScriptTool) Annotations() *mcp.ToolAnnotations {
	return &mcp.ToolAnnotations{
...
func (t *CreateScriptTool) Description() string { return "[editor-plugin] Creates a new script" }
func (t *CreateScriptTool) Annotations() *mcp.ToolAnnotations {
	return &mcp.ToolAnnotations{
		ReadOnlyHint: types.BoolPtr(false),
	}
}
...
func (t *AnalyzeScriptTool) Description() string { return "[file-based] Analyzes a script" }
func (t *AnalyzeScriptTool) Annotations() *mcp.ToolAnnotations {
	return &mcp.ToolAnnotations{
		ReadOnlyHint:   types.BoolPtr(true),
		IdempotentHint: types.BoolPtr(true),
	}
